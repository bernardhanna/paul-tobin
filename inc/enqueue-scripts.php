...
wp_add_inline_script(
  ...
  wp_register_style('nice-select-css','https://cdnjs.cloudflare.com/ajax/libs/jquery-nice-select/1.1.0/css/nice-select.min.css',[],'1.1.0');
  wp_register_script('nice-select-js','https://cdnjs.cloudflare.com/ajax/libs/jquery-nice-select/1.1.0/js/jquery.nice-select.min.js',['jquery'],'1.1.0',true);
  ...
  // Booking form block enhancement (native select fallback if script unavailable).
